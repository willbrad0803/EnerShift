...
class CustomUserCreationForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        user = User.objects.create_user(
            username=self.cleaned_data['email'],  # Email = Username
...
# ... (add_site, site_detail, upload_consumption, delete_site remain the same as before)
